            ...
            <div class="dropdown">
               <div class="draw">
                  ...
                  <div class="shirt">
                     ...
                     foreach ($dsdm_ao as $key => $value) : ?>
                        <a href="?act=timdm&iddm=<?= $value['id'] ?>" class="no-bold"><?= $value['name'] ?></a>
                     <?php endforeach; ?>
                  </div>
                  <div class="shirt">
                     <a href="" class="bold">Quần</a>
                     <?php
                     $dsdm_ao = danhsach_danhmuc_ao('2');
                     foreach ($dsdm_ao as $key => $value) : ?>
                        <a href="?act=timdm&iddm=<?= $value['id'] ?>" class="no-bold"><?= $value['name'] ?></a>
                     <?php endforeach; ?>
               ...
               <!-- <ul>
                  <?php foreach ($dsdm as $key => $value) : ?>
                     <li><a href="?act=timdm&iddm=<?php echo $value['id'] ?>"> <?php echo $value['name'] ?></a></li>
                  <?php endforeach; ?>
               </ul> -->
            </div>
         </li>
